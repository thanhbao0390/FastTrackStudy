/*
 * Viết chương trình quản lý sinh viên như ở assignment 3.
 
Yêu cầu:
1/ Thiết kế lớp SinhVien để lưu thông tin quản lý của sinh viên gồm:
Các thuộc tính:
•	Họ tên
•	Ngày sinh
•	Điểm LP1
...
Các phương thức:
•	Tính ĐTB
•	Xếp Loại sinh viên: dựa trên ĐTB: Giỏi (8.5 -> 10), Khá (7 -> 8.4), Trung bình (5 -> 6.9) và Kém (0 -> 4.9)
 
2/ Viết chương trình QuanLySinhVien.java, khai báo mảng sinh viên có kiểu dữ liệu là SinhVien và thực hiện các chức năng:
•	Nhập thông tin sinh viên
•	In danh sách sinh viên
•	In sinh viên cao điểm và thấp điểm nhất
•	In danh sách sinh viên theo thứ tự điểm trung bình từ cao đến thấp
...
public class QuanLySinhVien {
	...
	public static void nhapDSSV() {
			...
			for (int i = 0; i < n; i++) {
				...
				System.out.print("Nhập ngày sinh của sinh viên thứ "+ i +" :");
	...
	public static void showMyMenu() {
		while (true) {
			...
			if (myOption == 1) {
				...
				System.out.println("Bạn nhập sai vui lòng nhập lại từ 1 -8!!!");
				myScanner.nextLine();
			}
		}
	}
